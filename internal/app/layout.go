...
const (
	...
	LayoutMemoryFused     = "memory_fused" // Custom memory + fused metrics layout
)

var layoutOrder = []string{LayoutDefault, LayoutAlternative, LayoutAlternativeFull, LayoutVertical, LayoutCompact, LayoutDashboard, LayoutGaugesOnly, LayoutGPUFocus, LayoutCPUFocus, LayoutGPUMemory, LayoutMemory, LayoutNetworkIO, LayoutSmall, LayoutTiny, LayoutMicro, LayoutNano, LayoutPico, LayoutHistory, LayoutHistoryFull, LayoutHistorySoC, LayoutFan, LayoutPorts, LayoutInfo, LayoutMemoryFused}
...
var namedLayoutSetters = map[string]func(){
	...
	LayoutMemoryFused:     setMemoryFusedLayoutGrid,
