...
- **24 Layouts**: (`l` to cycle layouts) — includes a GPU + Memory focused layout with a DRAM read/write bandwidth history chart, a memory-pressure layout, a ports layout for listening TCP/UDP sockets, and the custom memory-fused layout
